 ...
 */
package info.laht.threej.exporters;
        ...
        if (iGeometry instanceof BufferGeometry) {
            ...
            if (vertices != null) {
                ...
                for (int i = 0, l = vertices.getCount(); i < l; i++, nbVertex++) {
                    ...
                    output.append("v ").append(vertex.x()).append(" ").append(vertex.y()).append(" ").append(vertex.z()).append("\n");
                }
            ...
            if (normals != null) {
                ...
                for (int i = 0, l = normals.getCount(); i < l; i++, nbNormals++) {
                    ...
                    output.append("vn ").append(normal.x()).append(" ").append(normal.y()).append(" ").append(normal.z()).append("\n");
            ...
            if (indices != null) {
                ...
                for (int i = 0, l = indices.getCount(); i < l; i += 3) {
                    ...
                    for (int m = 0; m < 3; m++) {
                        ...
                        face.add((indexVertex + j) + "/" + (uvs == null ? (indexVertexUvs + j) : "") + "/" + (indexNormals + j));
    ...
    private void parseLine(Line line) {
        ...
        if (line.type.equals("Line")) {
            ...
            for (int j = 1, k = j + 1, l = vertices.getCount(); j < l; j += 2, k = j + 1) {
                output.append("l ").append(indexVertex).append(j).append(' ').append(indexVertex).append(k).append("\n");
            }
