...
gb.Map = function(obj) {
	...
	this.upperMap = new ol.Map({
		controls : options.hasOwnProperty("upperMap") ? options.upperMap.hasOwnProperty("controls") ? options.upperMap.controls : undefined : undefined,
		pixelRatio : options.hasOwnProperty("upperMap") ? options.upperMap.hasOwnProperty("pixelRatio") ? options.upperMap.pixelRatio : undefined : undefined,
		interactions : options.hasOwnProperty("upperMap") ? options.upperMap.hasOwnProperty("interactions") ? options.upperMap.interactions : undefined : undefined,
		keyboardEventTarget : options.hasOwnProperty("upperMap") ? options.upperMap.hasOwnProperty("keyboardEventTarget") ? options.upperMap.keyboardEventTarget : undefined : undefined,
		layers : options.hasOwnProperty("upperMap") ? options.upperMap.hasOwnProperty("layers") ? options.upperMap.layers : undefined : undefined,
		maxTilesLoading : options.hasOwnProperty("upperMap") ? options.upperMap.hasOwnProperty("maxTilesLoading") ? options.upperMap.maxTilesLoading : undefined : undefined,
		loadTilesWhileAnimating : options.hasOwnProperty("upperMap") ? options.upperMap.hasOwnProperty("loadTilesWhileAnimating") ? options.upperMap.loadTilesWhileAnimating : undefined : undefined,
		loadTilesWhileInteracting : options.hasOwnProperty("upperMap") ? options.upperMap.hasOwnProperty("loadTilesWhileInteracting") ? options.upperMap.loadTilesWhileInteracting : undefined
				: undefined,
		moveTolerance : options.hasOwnProperty("upperMap") ? options.upperMap.hasOwnProperty("moveTolerance") ? options.upperMap.moveTolerance : undefined : undefined,
		overlays : options.hasOwnProperty("upperMap") ? options.upperMap.hasOwnProperty("overlays") ? options.upperMap.overlays : undefined : undefined,
		target : this.upperDiv[0],
		view : this.view
	});
	this.lowerMap = new ol.Map({
		controls : options.hasOwnProperty("upperMap") ? options.lowerMap.hasOwnProperty("controls") ? options.lowerMap.controls : undefined : undefined,
		pixelRatio : options.hasOwnProperty("lowerMap") ? options.lowerMap.hasOwnProperty("pixelRatio") ? options.lowerMap.pixelRatio : undefined : undefined,
		interactions : options.hasOwnProperty("lowerMap") ? options.lowerMap.hasOwnProperty("interactions") ? options.lowerMap.interactions : undefined : undefined,
		keyboardEventTarget : options.hasOwnProperty("lowerMap") ? options.lowerMap.hasOwnProperty("keyboardEventTarget") ? options.lowerMap.keyboardEventTarget : undefined : undefined,
		layers : options.hasOwnProperty("lowerMap") ? options.lowerMap.hasOwnProperty("layers") ? options.lowerMap.layers : undefined : undefined,
		maxTilesLoading : options.hasOwnProperty("lowerMap") ? options.lowerMap.hasOwnProperty("maxTilesLoading") ? options.lowerMap.maxTilesLoading : undefined : undefined,
		loadTilesWhileAnimating : options.hasOwnProperty("lowerMap") ? options.lowerMap.hasOwnProperty("loadTilesWhileAnimating") ? options.lowerMap.loadTilesWhileAnimating : undefined : undefined,
		loadTilesWhileInteracting : options.hasOwnProperty("lowerMap") ? options.lowerMap.hasOwnProperty("loadTilesWhileInteracting") ? options.lowerMap.loadTilesWhileInteracting : undefined
				: undefined,
		moveTolerance : options.hasOwnProperty("lowerMap") ? options.lowerMap.hasOwnProperty("moveTolerance") ? options.lowerMap.moveTolerance : undefined : undefined,
		overlays : options.hasOwnProperty("lowerMap") ? options.lowerMap.hasOwnProperty("overlays") ? options.lowerMap.overlays : undefined : undefined,
...
/**
 * 지도 영역의 크기를 현재 DIV 크기에 맞춰 업데이트한다.
 * 
 * @method gb.Map#updateSize
 */
