...
//	container.add( material );
	...
	var sidebarAttribute = new Sidebar.Object( editor );
	var attrTab = document.getElementById( 'attrAttr' );
	attrTab.appendChild( sidebarAttribute.dom );
	
	var sidebarGeometry = new Sidebar.Geometry( editor );
	var styleTab = document.getElementById( 'attrStyle' );
	styleTab.appendChild( sidebarGeometry.dom );
	
	var sidebarMaterial = new Sidebar.Material( editor );
	var materialTab = document.getElementById( 'attrMaterial' );
	materialTab.appendChild( sidebarMaterial.dom );
