...
THREE.OBJExporter.prototype = {
	...
	parse : function(object) {
		...
		var mtlFileName = 'objmaterial'; // maybe this value can be passed as
											// parameter
		...
		for ( var key in materials) {
			...
			mtlOutput += 'illum 2\n';
			mtlOutput += 'Ka ' + mat.color.r + ' ' + mat.color.g + ' '
					+ mat.color.b + ' ' + '\n';
			mtlOutput += 'Kd ' + mat.color.r + ' ' + mat.color.g + ' '
					+ mat.color.b + ' ' + '\n';
