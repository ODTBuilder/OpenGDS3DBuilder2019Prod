...
public class CylinderGeometry extends Geometry {
	...
	public CylinderGeometry(double radiusTop, double radiusBottom, double height, int radialSegments,
			int heightSegments) {
		this(radiusTop, radiusBottom, height, radialSegments, heightSegments, false, Angle.rad(0),
				Angle.rad(2 * Math.PI));
	}

	public CylinderGeometry(double radiusTop, double radiusBottom, double height, int radialSegments,
			int heightSegments, boolean openEnded, Angle thetaStart, Angle thetaLength) {
