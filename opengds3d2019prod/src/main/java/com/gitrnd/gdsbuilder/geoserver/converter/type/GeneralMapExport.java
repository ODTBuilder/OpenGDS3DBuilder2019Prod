...
public class GeneralMapExport {
	 ...
	 */
	public GeneralMapExport(String serverURL, String workspace, String layerName, String outputFolderPath,
			String srs) {
		if (serverURL.isEmpty() || workspace.isEmpty() || layerName.isEmpty() || outputFolderPath.isEmpty() || srs.isEmpty()) {
