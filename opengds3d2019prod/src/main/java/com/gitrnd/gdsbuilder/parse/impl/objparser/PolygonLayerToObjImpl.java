...
/**
 * Polygon 타입의 2D FeatureCollection 객체를 3D Obj 객체로 변환하여 Obj 파일을 생성하는 클래스
 * 
 * @author DY.Oh
 *
 */
public class PolygonLayerToObjImpl {
	...
	/**
	 * BufferedWriter, Obj file writer
	 */
	...
	/**
	 * PolygonLayerToObjImpl 생성자
	 * 
	 * @param buildingCollection 2D FeatureCollection
	...
	/**
	 * Polygon 타입의 2D FeatureCollection 객체를 3D Obj 객체로 변환
	 * 
