...
import com.gitrnd.qaproducer.common.locale.UrlLocaleInterceptor;
import com.gitrnd.qaproducer.common.locale.UrlLocaleResolver;
...
public class WebMvcConfig implements WebMvcConfigurer {
	...
	public void addInterceptors(InterceptorRegistry registry) {
		...
		registry.addInterceptor(localeInterceptor).addPathPatterns("/en/*", "/ko/*");
	}
