...
public class DownloadService {
	...
	public void download3dtilesZip(HttpServletResponse response, String path) {

		File tileset = new File(path);
		File parent = tileset.getParentFile();

//		try {
//			URL url = new URL(path);
//			LOGGER.info("{} has been requested [origin layer]", path);
